...
class Database:
  ...
  def persist(self, splitted):
    ...
    if "value" not in self.database[splitted[1]]:
      ...
      if len(splitted) == 5:
        ...
        new_hash = str(hash(str(splitted)))
        splitted.append(new_hash)
        temp = splitted[3]
        splitted[3] = new_hash
        splitted[4] = temp
      val = Value(splitted[0], splitted[1], splitted[2])
      val.hash = splitted[3]
      val.time = splitted[4]
      ...
      if len(splitted) == 5:
        ...
        previous_version = str(self.database[splitted[1]]["value"][-1].hash)
        new_hash = str(hash(previous_version + str(hash(str(splitted)))))
        splitted.append(new_hash)
        temp = splitted[3]
        splitted[3] = new_hash
        splitted[4] = temp
  ...
  def getvalue(self, name):
    ...
    self.cached = self.database[name]["value"][0]
    return self.cached 
